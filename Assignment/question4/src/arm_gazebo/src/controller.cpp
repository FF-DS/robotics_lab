...
namespace gazebo
{
	...
	private: ros::Subscriber subscribeAngleState;
	...
	public:
		...
		void Load(physics::ModelPtr _parent, sdf::ElementPtr /*_sdf*/)
		{
			...
			ModelPush modelPush;
			this->subscribeAngleState = m.subscribe("UpdateJointAngles", 1000, &ModelPush::updateJointAngleCallback, this);
			// ------------  end ------------- // 
	...
	public:
		...
		{
			this->model->GetJoints()[0]->SetPosition(0, angleState->angleOne * M_PI/ 180.0 );
			this->model->GetJoints()[1]->SetPosition(0, angleState->angleTwo * M_PI/ 180.0 );
			this->model->GetJoints()[2]->SetPosition(0, angleState->angleThree * M_PI/ 180.0 );
			this->model->GetJoints()[3]->SetPosition(0, angleState->angleFour * M_PI/ 180.0 );
		}
	...
	public:
		void OnUpdate()
		{
			...
			tmp1 << "name : " << this->model->GetJoints()[0]->GetName()  << " angel : " << this->model->GetJoints()[0]->Position(0) * 180.0 / M_PI;
			tmp2 << "name : " << this->model->GetJoints()[1]->GetName()  << " angel : " << this->model->GetJoints()[1]->Position(0) * 180.0 / M_PI;
			tmp3 << "name : " << this->model->GetJoints()[2]->GetName()  << " angel : " << this->model->GetJoints()[2]->Position(0) * 180.0 / M_PI;
			tmp4 << "name : " << this->model->GetJoints()[3]->GetName()  << " angel : " << this->model->GetJoints()[3]->Position(0) * 180.0 / M_PI;
